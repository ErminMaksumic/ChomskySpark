...
class _ObjectDetectionPageState extends State<ObjectDetectionPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
    appBar: AppBar(
         title: Text('Object Detection', style: TextStyle(color: Colors.white, fontSize: 22)),
      ...
      body: Column(
        children: [
         Padding(
                  ...
                  child: Text(
                    "Who’s ready for another round of object detective work? 🕵️‍♂️🔍", // Fun and playful text
                    style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold),
                  ),
                ),

                // Retake button with icon
                Padding(
                  padding: const EdgeInsets.all(16.0),
                  child: ElevatedButton.icon(
                    onPressed: () {
                      // Your retake functionality here
                    },
                    icon: Icon(Icons.refresh, color: Colors.white), // Retake icon
