      ...
      body: _isLoading
        ...
        children: [
          Padding(
            ...
            child: Text('Success Rate Over Time', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.bold)),
          ),
          Expanded(
            child: Padding(
              padding: const EdgeInsets.all(12),
                    ...
                    bottomTitles: AxisTitles(
                      sideTitles: SideTitles(
                        ...
                        getTitlesWidget: (double value, TitleMeta meta) {
                          final date = data[value.toInt() % data.length].date.toString().split('-')[2] + " Jan";
                          return Padding(
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text('Success Rates (%) by Dates last 7 days', style: TextStyle(color: Colors.purple, fontSize: 14)),
              ],
            ),
          ),
        ],
